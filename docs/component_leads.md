...
efforts and be the point of contact in case of problems. The expectations on
component leads and their deputies are described in detail in the
[component lead duties](./component_lead_duties.md) guide.
...
|[Consistency checks](https://github.com/rucio/rucio/issues?q=label%3A%22Consistency+checks%22+is%3Aissue+is%3Aopen) | [Fabio Luchetti](https://github.com/faluchet) | Consistency between catalogue and storage, dark data and lost file detection: Auditor|
...
|[Docker & Kubernetes](https://github.com/rucio/rucio/issues?q=is%3Aopen+is%3Aissue+label%3A%22Docker+%26+Kubernetes%22) | [Benedikt Ziemons](https://github.com/bziemons) | Container images, Helm charts, and the Kubernetes tutorial for deploying Rucio ([rucio/containers](https://github.com/rucio/containers), [rucio/helm-charts](https://github.com/rucio/helm-charts), [rucio/k8s-tutorial](https://github.com/rucio/k8s-tutorial))|
|[Documentation](https://github.com/rucio/rucio/issues?q=label%3A%22Documentation%22+is%3Aissue+is%3Aopen) | [Maggie Voetberg](https://github.com/voetberg), [Martin Barisits](https://github.com/bari12) | Code documentation and project documentation: [rucio/documentation](https://github.com/rucio/documentation) repository and the documentation website|
|[Jupyterlab extension](https://github.com/rucio/jupyterlab-extension/issues) | [Francesc Torradeflot](https://github.com/ftorradeflot), [Giovanni Guerrieri](https://github.com/Soap2G) | JupyterLab extension to browse and access Rucio data from notebooks ([rucio/jupyterlab-extension](https://github.com/rucio/jupyterlab-extension))|
...
|[Metadata](https://github.com/rucio/rucio/issues?q=label%3A%22Metadata%22+is%3Aissue+is%3Aopen) | [Rob Barnsley](https://github.com/robbarnsley), [Dimitrios Xenakis](https://github.com/Geogouz) | DID metadata storage and querying, including plugins for external metadata catalogues|
...
|[Multi VO](https://github.com/rucio/rucio/issues?q=is%3Aopen+is%3Aissue+label%3A%22Multi+VO%22) | [Tim Noble](https://github.com/Thysk) | Running a single Rucio instance serving multiple virtual organisations (Multi-VO mode)|
|[Policies](https://github.com/rucio/rucio/issues?q=is%3Aopen+is%3Aissue+label%3APolicies) | [James Perry](https://github.com/jamesp-epcc) | Community-specific policy packages: permission models, schema validation, and algorithms|
...
|[REST & API](https://github.com/rucio/rucio/issues?q=is%3Aopen+is%3Aissue+label%3A%22REST+%26+API%22) | [Maggie Voetberg](https://github.com/voetberg), [Martin Barisits](https://github.com/bari12) | REST API endpoints and the Flask web framework|
