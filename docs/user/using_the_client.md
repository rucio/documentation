...
and `multi_host_servers`. `multi_host_commands` should contain a comma separated list
with commands that will be called on all servers and multi_host_servers should contain
