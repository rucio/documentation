...
See [SITE_NAME](#SITE-NAME).

### CONDA_PREFIX

See [RUCIO_HOME](#RUCIO-HOME).
...
Valid options are `gss`, `oidc`, `ssh`, `userpass`, `x509`, and `x509_proxy`.
...
See [RUCIO_LATITUDE](#RUCIO-LATITUDE).
